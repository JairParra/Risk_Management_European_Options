...
### Transforming back the invariants to prices 

**From GARCH(1,1) residuals to SP500 observations** 
...
# data from up to T 
y <- sp500_rets_vec
sig2 <- fit_garch$sig2_hat 
theta <- fit_garch$theta_hat 

# initial parameters
y_prev <- y[length(y)] 
sig2_prev <- sig2[length(sig2)]
