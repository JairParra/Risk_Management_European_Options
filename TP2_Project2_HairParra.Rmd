...
PL_mats <- lapply(rep(1, 3), # generate three empty matrices of compatible sizes
                  function(x){
                    matrix(NA, 
...
### Distribution of the Book Of Options 
