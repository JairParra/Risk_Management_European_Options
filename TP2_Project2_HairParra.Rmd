...
```{r, echo=FALSE}
## Saving this data into an external datafile : 
...
Next, we create a function to forecast the 5 day ahead prices from the returns. Since: 
...
save(sim_price_sp500, file=here("data_out", "sim_vol_sp500_student_copula.rda"))
save(sim_vol_vix, file=here("data_out", "sim_vol_vix_student_copula.rda"))
```
