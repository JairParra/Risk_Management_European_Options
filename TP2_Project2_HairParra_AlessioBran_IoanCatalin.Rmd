...
First, obtain last conditional variance available (up to time T), and then we forecast the conditional variances five days ahead, starting with the last variance: 
